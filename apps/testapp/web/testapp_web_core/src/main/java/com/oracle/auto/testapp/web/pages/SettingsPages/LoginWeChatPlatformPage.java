 ...
 */
@Component
public class LoginWeChatPlatformPage extends TestAppPageBase {
    ...
    public void init() {
        ...
        String loginUrl = PropertyConfiger.instance().getEnvData("wechat.platform.url","");
                //page.serverDefaultURL();
        page.open(loginUrl);
