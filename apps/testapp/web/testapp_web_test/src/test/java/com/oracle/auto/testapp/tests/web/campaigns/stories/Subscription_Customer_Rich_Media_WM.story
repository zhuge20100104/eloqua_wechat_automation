...
|0      |Customer_订阅号图文消息一     |作者一      |订阅号图文消息customer一   |http://cn.bing.com/    |
|1      |Customer_订阅号图文消息二     |作者二      |订阅号图文消息customer二   |%subscription.account.registration.landing.page% |
...
|OMCWI研发订阅号       |Customer_订阅号图文消息一      |作者一      |订阅号图文消息customer一   |http://cn.bing.com/  |
...
Examples:
|accountName          |title                          |author     |content                     |contentURL                            |
|OMCWI研发订阅号       |Customer_订阅号图文消息二      |作者二      |订阅号图文消息customer二   |%subscription.account.registration.landing.page% |
