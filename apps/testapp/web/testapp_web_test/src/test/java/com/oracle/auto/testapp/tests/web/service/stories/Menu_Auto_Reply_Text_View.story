...
Narrative:
View new auto reply text message for service account

Scenario: View new auto reply text message for service account
Given login Eloqua
...
|OMCWI研发服务号 |%RAND_NUM%_文本扫码发消息测试_%RAND_NUM%  |你好！文本-扫码发消息测试！|Email Address|
