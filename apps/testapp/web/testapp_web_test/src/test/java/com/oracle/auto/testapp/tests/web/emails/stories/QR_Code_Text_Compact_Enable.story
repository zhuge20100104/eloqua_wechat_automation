...
Scenario: Create a new QR code: compact, text, enable welcome message
...
Json: QRCodeEmail
{
    ...
    emailSubject: "compact, text, enable welcome message %RAND_NUM%",
    QRCodeName: "QRCodeName%RAND_NUM%",
    accountName: "OMCWI研发服务号",
    textContent: "auto test text with compact QRCode and enable welcome message"
}