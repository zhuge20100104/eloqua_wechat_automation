...
Narrative:
Setup messaeg then cheak in browser: campaign to send broadcase text message to serivce account to some followers

Scenario: Send broadcase text message to serivce account with segment
Given login Eloqua
