...
|wechat.autotest%RAND_NUM%@blackhole.oracle.com |%eloqua.wechat.form%  |Two minutes  |%service_open_id% |time out message|thanks complete message| submission message|
